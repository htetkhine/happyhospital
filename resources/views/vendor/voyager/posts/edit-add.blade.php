                            ...
                            <div class="links">
                                <h3 class="panel-title">
                                    ...
                                    <span class="panel-desc">
                                        {{-- <a href="{{ route('article', [app()->getLocale(), $dataTypeContent->slug ]) }}">{{ route('article', [app()->getLocale(), $dataTypeContent->slug ]) }} </a> --}}
                                    </span>
                                </h3>
                            </div>
                            @endif
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label class="bold" for="slug">{{ __('voyager::post.slug') }}</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'slug',
                            ...
                            <div class="form-group">
                                <label class="bold" for="status">{{ __('voyager::post.status') }}</label>
                                    ...
                                    @if(!in_array($row->field, $exclude))
                                        ...
                                        @else
                                            <div class="form-group @if($row->type == 'hidden') hidden @endif @if(isset($display_options->width)){{ 'col-md-' . $display_options->width }}@endif" @if(isset($display_options->id)){{ "id=$display_options->id" }}@endif>
                                                {{ $row->slugify }}
                                                <label class="bold" for="name">{{ ucfirst((($row->display_name) == 'Created At')?'Published Date ( Created At )': $row->getTranslatedAttribute('display_name')) }}</label>
                                                @if(($row->display_name) == 'categories')
                                                    {!! $opendiv !!}
                                                @endif
